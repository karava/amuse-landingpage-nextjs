...
export const URL = "https://www.amuse.so";
...
export const NavLinks = {
  ...
  socials: [
    { icon: <FaFacebook size={22} />, href: "https://www.facebook.com/share/LHcCxEbGBiNQrsjp/?mibextid=LQQJ4d" },
    { icon: <RiInstagramFill size={24} />, href: "https://www.instagram.com/amuse.so" },
    { icon: <FaLinkedin size={22} />, href: "https://www.linkedin.com/company/amuse-explore-and-grow/" },
    { icon: <FaXTwitter size={22} />, href: "https://x.com/amusequicklearn" },
  ],
};
